                ...
                <div class="col-sm-4">
                    ...
                    <div class="panel-body">
                        <ul id="tabela" class="list-group">
                            <li id="biscoito" class="list-group-item" data-seller= "Charli"><strong>Café rapidinho</strong>
                                <br>Curto
                                <br>Pingado
                            </li>

                            <li id="nome" class="list-group-item" data-seller= "Paula"><strong>Trufelícia</strong>
                                <br>Chocolate e doce de leite
                                <br>Morango com maracujá
                            </li>
                        </ul>
                    </div>
                </div>
